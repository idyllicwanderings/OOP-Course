...
public class TaskContainer {
    ...
    public State getDirection(int curFloor, State curState) {
        ...
        if (min < curFloor && curState.equals(State.DOWN)) {
            return State.DOWN;
        } else if (max > curFloor && curState.equals(State.UP)) {
            return State.UP;
        } else if (min < curFloor && curState.equals(State.UP)) {
            return State.DOWN;
        } else if (max > curFloor && curState.equals(State.DOWN)) {
            return State.UP;
        } else {
